        ...
        >
          <swiper-slide v-for="(page, index) in pages" :key="index">
            <div class="slide-content">
              <img :src="`https://apiServer.myshakes.cc${page.image_url}`"  class="page-image" alt="story-page" />
    ...
    <div style="position: absolute; left: -9999px; top: 0;">
      <div id="pdf-content" v-if="pages.length > 0" style="width: 210mm; background: white;">
        <div v-for="(page, index) in pages" :key="index" class="pdf-page">
          <img :src="`https://apiServer.myshakes.cc${page.image_url}`"  crossOrigin="anonymous" style="width: 100%; height: 100%; object-fit: cover;">
