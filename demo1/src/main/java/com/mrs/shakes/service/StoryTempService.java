...
import com.mrs.shakes.client.ComfyUiClient;
import com.mrs.shakes.client.OllamaClient;
import com.mrs.shakes.controller.BookStoryController;
...
public class StoryTempService {
 ...
 public NextSceneResponse generateNextScene(NextSceneRequest req) {
        ...
        String nextPart = ollamaClient.generate(prompt);
